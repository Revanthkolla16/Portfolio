    ...
    <section id="hero" style={{
      ...
      <div style={{
        ...
        <div className="animate-fade-up-6 delay-1" style={{ display: 'flex', gap: 20, marginBottom: 56, alignItems: 'center' }}>
          ...
          <a href={personal.leetcode} target="_blank" rel="noopener noreferrer" style={{ color: 'var(--text-secondary)', transition: 'color 0.2s', fontSize: '24px', lineHeight: 1 }} onMouseEnter={e => e.currentTarget.style.color = 'var(--text-primary)'} onMouseLeave={e => e.currentTarget.style.color = 'var(--text-secondary)'}>
            🧩
          </a>
